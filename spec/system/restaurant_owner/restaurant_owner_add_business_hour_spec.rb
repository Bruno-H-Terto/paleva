...
describe 'Usuário acessa área do Proprietário', js: true do
  let(:owner) {
  ...
  context 'estando autenticado' do
    ...
    it 'e registra seu horário de funcionamento' do
      ...
      fill_in_hours_for_day('monday', '09:00', '17:00', true)
      fill_in_hours_for_day('tuesday', '09:00', '17:00', true)
      fill_in_hours_for_day('wednesday', '09:00', '17:00', true)
      fill_in_hours_for_day('thursday', '09:00', '17:00', true)
      fill_in_hours_for_day('friday', '09:00', '17:00', false)
      fill_in_hours_for_day('saturday', '', '', false)
      fill_in_hours_for_day('sunday', '', '', false)
      click_on 'Cadastrar'
